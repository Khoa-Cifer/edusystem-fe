...
import { Users, Award, AlertCircle, Target, TrendingUp, TrendingDown } from "lucide-react"
          ...
          <TabsContent value="performance">
            <Card className="p-6 bg-card border-border">
              ...
              {[{
                ...
                <div key={i} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg mb-2 hover:bg-muted transition-colors">
                  <span className="font-medium">{student.name}</span>
                  <div className="flex items-center gap-3">
                    <span>{student.score}%</span>
                    <Badge
                      variant="outline"
                      className={student.score >= 90 ? "text-accent border-accent" : "text-secondary border-secondary"}
                    >
                      {student.status}
                    </Badge>
                  </div>
